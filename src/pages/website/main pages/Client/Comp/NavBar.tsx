              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="absolute bottom-0 right-0 inline-flex items-center justify-center gap-1 rounded-full border-2 border-white bg-pink-500 p-1 text-sm text-white">
                    <span className="sr-only">7 new notifications</span>
                  </span>
                </button>
                ...
                {isAvatarMenuOpen && (
                  <div className="absolute right-0 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    ...
                    <Link to="notifications" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Notifications
                      <span className="ml-2 inline-flex items-center justify-center rounded-full bg-pink-500 px-2 py-1 text-xs font-bold text-white">
                        7
                      </span>
                    </Link>
                    <hr className="border-gray-200" />
